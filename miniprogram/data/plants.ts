...
export const plantKnowledge: PlantKnowledge[] = [
  {
    ...
    imagePath: '/assets/plants/monstera.jpg',
    confidence: 0.94,
    tags: ['观叶', '室内', '耐阴'],
    care: {
  ...
  },
  {
    ...
    imagePath: '/assets/plants/ficus.jpg',
    confidence: 0.91,
    tags: ['观叶', '室内', '木本'],
    care: {
  ...
  },
  {
    ...
    imagePath: '/assets/plants/haworthia.jpg',
    confidence: 0.89,
    tags: ['多肉', '耐旱', '小型'],
    care: {
  ...
  },
  {
    ...
    imagePath: '/assets/plants/fern.jpg',
    confidence: 0.88,
    tags: ['蕨类', '室内', '喜湿润'],
    care: {
...
export function findPlantKnowledge(id: string): PlantKnowledge | undefined {
  return plantKnowledge.find((plant) => plant.id === id)
}
...
export function searchPlantKnowledge(keyword: string): PlantKnowledge[] {
  ...
  return plantKnowledge.filter((plant) => {
    const searchable = [plant.name, plant.latinName, ...plant.aliases].join(' ').toLowerCase()
